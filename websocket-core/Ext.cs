...
namespace WebSocketCore
{
    ...
    public static class Ext
    {
        ...
        internal static IAsyncResult BeginWrite(this Stream stream, byte[] buffer, int offset, int length,
            AsyncCallback callback, object state)
        {
            return TaskToApm.Begin(stream.WriteAsync(buffer, offset, length), callback, state);
        }

        internal static IAsyncResult BeginRead(this Stream stream, byte[] buffer, int offset, int length,
            AsyncCallback callback, object state)
        {
