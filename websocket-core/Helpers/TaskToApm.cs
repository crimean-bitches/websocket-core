...
namespace WebSocketCore.Helpers
{
    /// <summary>
    ...
    public static class TaskToApm
    {
        ...
        public static IAsyncResult Begin(Task task, AsyncCallback callback, object state)
        {
            ...
            else
            {
                ...
                asyncResult = task.AsyncState == state
                    ? (IAsyncResult) task
        ...
        public static void End(IAsyncResult asyncResult)
        {
            ...
            if (task == null)
                throw new ArgumentException("Wrong async result.");
        ...
        private static void InvokeCallbackWhenTaskCompletes(Task antecedent, AsyncCallback callback,
            IAsyncResult asyncResult)
        {
        ...
        private sealed class TaskWrapperAsyncResult : IAsyncResult
        {
            ...
            {
                Contract.Requires(task != null);
                Contract.Requires(!completedSynchronously || task.IsCompleted,
